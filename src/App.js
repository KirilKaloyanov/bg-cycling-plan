    ...
    return (
      <>
        ...
        <div className="footer">
          <img className='dtpLogo' src={dtpLogo} alt='Danube Transnational Programme logo' />
          <div className='funding'>Project is co-funded by the European Union funds (ERDF,IPA)</div>
        </div>
      </>
    );
  }
